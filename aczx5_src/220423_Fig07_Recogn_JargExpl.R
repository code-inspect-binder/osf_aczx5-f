## *****************************************************************************
## ** TERRAIN AND TRAVEL ADVICE - FIG 7: RECOGNITION - JARGON AND EXPLANATION **
## *****************************************************************************
##
...
## Settings for figure
Export <- TRUE
FileName <- "Fig07_Recogn_JargExpl_hires.png"
FigWidth <- 15
FigHeight <- 7
LineWidth <- 1.5
LineWidthSign <- 1.5
...
plot(XAxis1, ExcProp1, ylab = "Probability of selecting 'Very/Extremely confident'", 
