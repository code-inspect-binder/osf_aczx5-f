## **********************************************************************
## ** TERRAIN AND TRAVEL ADVICE - EXAMINATION OF UNDERSTANDABLE MODELS **
## **********************************************************************
##
...
at_but <- list(Jargon = RL_Jargon,
               ...
               cut = RL_cut)
grid_but <- ref_grid(clmm_underjar, mode = "exc.prob", at = at_but)
...
at_days <- list(Jargon = RL_Jargon,
                ...
                BackgrYrsOfExp = RL_BackgrYrsOfExp,
                cut = RL_cut)
grid_days <- ref_grid(clmm_underjar, mode = "exc.prob", at = at_days)
...
at_yrs <- list(Jargon = RL_Jargon,
               ...
               BullUseType = RL_BullUseType,
               cut = RL_cut)
grid_yrs <- ref_grid(clmm_underjar, mode = "exc.prob", at = at_yrs)
...
at_att <- list(Jargon = RL_Jargon,
               ...
               BullUseType = RL_BullUseType,
               cut = RL_cut)
grid_att <- ref_grid(clmm_underjar, mode = "exc.prob", at = at_att)
emmip(grid_att, ~ TrvlAdv_Atten, mode = "exc.prob", at = at_att, CIs = T)

## Consecutive
emmeans(grid_att, specs = consec ~ TrvlAdv_Atten)
...
at_but <- list(Expl = RL_Expl,
               ...
               BackgrYrsOfExp = RL_BackgrYrsOfExp,
               cut = RL_cut)
grid_but <- ref_grid(clmm_underexp, mode = "exc.prob", at = at_but)
emmip(grid_but, ~ BullUseType, mode = "exc.prob", at = at_but, CIs = T)
...
at_days <- list(Expl = RL_Expl,
                ...
                BackgrYrsOfExp = RL_BackgrYrsOfExp,
                cut = RL_cut)
grid_days <- ref_grid(clmm_underexp, mode = "exc.prob", at = at_days)
emmip(grid_days, ~ BackgrDaysPerYr, mode = "exc.prob", at = at_days, CIs = T)
...
at_yrs <- list(Expl = RL_Expl,
               ...
               BullUseType = RL_BullUseType,
               cut = RL_cut)
grid_yrs <- ref_grid(clmm_underexp, mode = "exc.prob", at = at_yrs)
emmip(grid_yrs, ~ BackgrYrsOfExp, mode = "exc.prob", at = at_yrs, CIs = T)
...
at_att <- list(Expl = RL_Expl,
               ...
               BullUseType = RL_BullUseType,
               cut = RL_cut)
grid_att <- ref_grid(clmm_underexp, mode = "exc.prob", at = at_att)
emmip(grid_att, ~ TrvlAdv_Atten, mode = "exc.prob", at = at_att, CIs = T)
